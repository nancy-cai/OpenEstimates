...
class LeadCapturePageLocators(object):
    ...
    new_lead_title = (By.XPATH, "//*[@id='leadcapture-box']/div/div/h2")    
    lead_name = (By.ID,"name-input-lead")
    lead_email = (By.ID,"email-input-lead")
    lead_phone = (By.ID,"phone-input-lead")
    get_my_estimate_btn = (By.XPATH, "//*[@id='leadcapture-box']/div/div/a")
    sign_in_title = (By.XPATH, "//*[@id='signin-box']/div/div/p[1]")
    sign_in_password = (By.ID, "signin-password-input-lead")
    see_my_estimate_btn = (By.XPATH, "//*[@id='signin-box']/div/div/a")
...
class PropertyPageLocators(object):
    property_guide = (By.ID, "property-guide")
    pp_address = (By.XPATH, "//*[@id='property-logged-out']/main/section[2]/div/h2")